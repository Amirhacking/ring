...
✥ از اینکه ربات رایگان راد را به عنوان ربات منتخب برای گروه خود انتخاب کرده اید سپاس گذاریم !

لطفا متن زیر را کاملا با دقت مطالعه فرمایید :

1-ابتدا لینک گروه خود را برداشته و سپس با استفاده از دستور زیر ربات را مانند مثال به گروه خود دعوت نمایید !

ایمپورت https://t.me/joinchat/hNeTvowhWDBhM2Rk

به جای لینک لینک گروه خود را جایگزین کنید !

سپس دستور "`نصب`" را در گروه خود ارسال کرده و طبق دستوراتی که مرحله به مرحله داده میشود عمل کنید !

ღ با تشکر از حسن انتخاب شما !

کانال خبرگذاری ربات :

❥ @iranize_tesla_team  ツ
]]
...
sendText(msg.chat_id,msg.id,'`help bot in this channel:` https://t.me/iranize_tesla_teamHelp','html')
end
end
-----------------------------------------------
if is_Owner (msg) then
...
if matches == 'amir' or matches == 'امیر' or matches == 'امیرلاشی' or matches == 'امیر لاشی' or matches == 'عمیر' or matches == 'عمیرلاشی' or matches == 'عمیر لاشی' or matches == 'amir lashi' then
local sina = {'چیکارش داری؟','کارتو بگو بیاد جواب میده','برو پیویش @refigh_heh','نیست'}
